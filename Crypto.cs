...
namespace snesclassicalert
{
    ...
    public class Crypto
    {
        private static byte[] initVectorBytes = Encoding.ASCII.GetBytes("S9lYKZ9YMhWPeD0z");
        private static byte[] saltValueBytes = Encoding.ASCII.GetBytes("CUoB3N02hq");
        private static string key = "E2OfJ0DvfZ";
        private static string hashAlgorithm = "SHA1";
        private static int passwordIterations = 3;
